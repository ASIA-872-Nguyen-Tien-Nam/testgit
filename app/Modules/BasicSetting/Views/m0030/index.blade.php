...
@section('asset_header')
	{!! public_url('template/css/basicsetting/m0030/m0030.index.css') !!}
@stop

@section('asset_footer')
	{!! public_url('template/js/basicsetting/m0030/m0030.index.js') !!}
@stop
...
<div class="container-fluid">
	<div class="row">
		<div id="leftcontent" class="col-sm-12 col-md-4 col-lg-3 col-ltx-2">
			<div class="inner">
				@include('BasicSetting::m0030.leftcontent')
			</div> <!-- end .inner -->
		</div> <!-- end #leftcontent -->
		<div id="rightcontent" class="col-sm-12 col-md-8 col-lg-9 col-ltx-10">
			<div class="inner">
				@include('BasicSetting::m0030.rightcontent')
