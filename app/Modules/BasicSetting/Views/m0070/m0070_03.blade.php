                        ...
                        <tbody class="list_tab_03">
                            ...
                            <tr class="tr">
                                <td>
                                    <span class="num-length">
                                        <div class="input-group-btn">
                                            <input type="text" class="d-none detail_no"
                                                value="{{ $row['detail_no'] ?? '0' }}">
                                            <input {{ $disabled }} {{$tab_03['disabled_tab03']}} type="text" class="form-control training_cd"
                                                trainings="{{ $tab_03['trainings'] ?? '' }}" maxlength="6"
                                                editable_kbn = "{{ $editable_kbn ?? '1' }}"
                                                value="{{ $row['training_cd'] ?? '' }}" tabindex="9"
                                                autocomplete="off">
                                        </div>
                                    </span>
                                </td>
                                <td colspan="4">
                                    <span class="num-length">
                                        <input {{ $disabled }} {{$tab_03['disabled_tab03']}} type="text" tabindex="9"
                                            ...
                                            @if ((isset($editable_kbn) && $editable_kbn == 0) || !isset($editable_kbn)) disabled @endif
                                            value="{{ $row['training_nm'] ?? '' }}" decimal="2">
                                    </span>
                                </td>
                                <td colspan="4">
                                    <span class="num-length">
                                        <select {{ $disabled }} {{$tab_03['disabled_tab03']}} name=""
                                            ...
                                            @if (!empty($tab_03['M5031']))
                                                @foreach ($tab_03['M5031'] as $item)
                                                    <option value="{{ $item['training_category_cd'] }}"
                                                        @if (isset($row['training_category_cd']) && $row['training_category_cd'] == $item['training_category_cd']) selected @endif>
                                ...
                                <td colspan="4">
                                    <span class="num-length">
                                        <select {{ $disabled }} {{$tab_03['disabled_tab03']}} name=""
                                            class="form-control training_course_format_cd"
                                            @if ((isset($editable_kbn) && $editable_kbn == 0) || !isset($editable_kbn)) disabled @endif tabindex="9">
                                            <option value="0"></option>
                                            @if (!empty($tab_03['M5032']))
                                                @foreach ($tab_03['M5032'] as $item)
                                                    <option value="{{ $item['training_course_format_cd'] }}"
                                                        @if (isset($row['training_course_format_cd']) && $row['training_course_format_cd'] == $item['training_course_format_cd']) selected @endif>
                                ...
                                <td colspan="4">
                                    <span class="num-length">
                                        <input {{ $disabled }} {{$tab_03['disabled_tab03']}} type="text" tabindex="9"
                                            class="form-control input-sm text-left lecturer_name"
                                            value="{{ $row['lecturer_name'] ?? '' }}" maxlength="20">
                                    </span>
                                </td>
                            </tr>
                            <tr class="tr">
                            ...
                            <tr class="tr">
                                ...
                                <td colspan="2">
                                    <span class="num-length input_date">
                                        <div class="input-group-btn input-group">
                                            <input {{ $disabled }} {{$tab_03['disabled_tab03']}} type="text"
                            ...
                            <tr class="tr">
                                        ...
                                        <select {{ $disabled }} {{$tab_03['disabled_tab03']}} class="form-control report_submission"
                                            ...
                                            @if (!empty($tab_03['L0010_60']))
                                                @foreach ($tab_03['L0010_60'] as $item)
                                                    <option value="{{ $item['number_cd'] }}"
                                                        @if (isset($row['report_submission']) && $row['report_submission'] == $item['number_cd']) selected @endif>
                                                        {{ $item['name'] }}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                ...
                                <td colspan="2" class="input_date">
                                    <span class="num-length ">
                                        <div class="input-group-btn input-group">
                                            <input {{ $disabled }} {{$tab_03['disabled_tab03']}} type="text"
                                                class="form-control input-sm date report_submission_date"
                                                value="{{ $row['report_submission_date'] ?? '' }}"
                                                placeholder="yyyy/mm/dd" tabindex="9">
                                            <div class="input-group-append-btn">
                                                <button class="btn btn-transparent" type="button" tabindex="-1"><i
                                                        class="fa fa-calendar"></i></button>
                                ...
                                <td colspan="14">
                                    <span class="num-length">
                                        <input {{ $disabled }} {{$tab_03['disabled_tab03']}} type="text" tabindex="9"
                                            value="{{ $row['report_storage_location'] ?? '' }}" maxlength="50"
                    ...
                    <tbody class="list_tab_03">
                        ...
                        <tr class="tr">
                            <td colspan="4">
                                <div class="d-flex">
                                    <span class="num-length">
                                        <div class="input-group-btn input-group" style="min-width: 160px;">
                                            <input {{ $disabled }} {{$tab_03['disabled_tab03']}} type="text"
                                                class="form-control input-sm date training_date_from"
                                                placeholder="yyyy/mm/dd" tabindex="9">
                                            <div class="input-group-append-btn">
                                    ...
                                    <span class="num-length" style="min-width: 160px;">
                                        <div class="input-group-btn input-group">
                                            <input {{ $disabled }} {{$tab_03['disabled_tab03']}} type="text"
                                                class="form-control input-sm date training_date_to"
                                                placeholder="yyyy/mm/dd" tabindex="9">
