...
{!! public_url('template/css/basicsetting/sS0020/sS0020.index.css') !!}
@stop

@section('asset_footer')
    {!!public_url('template/js/basicsetting/sS0020/sS0020.index.js')!!}
@stop

@push('asset_button')
{!!
	Helper::buttonRender(['addNewSignupButton', 'saveButton', 'deleteButton' , 'backButton'])
!!}
@endpush
