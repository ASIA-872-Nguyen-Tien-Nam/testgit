...
{!! public_url('template/css/employeeinfo/em0020.index.css') !!}
@stop
...
{!! public_url('template/js/employeeinfo/em0020.index.js') !!}
@stop
@push('asset_button')
{!!
	Helper::dropdownRenderEmployeeInformation(['createSelect','addNewButton','saveButton','deleteButton','backButton'])
!!}
@endpush
@section('content')
	<!-- START CONTENT -->
	<div class="container-fluid">
		<div class="row">
			<div id="leftcontent" class="col-sm-12 col-md-4 col-lg-3 col-ltx-2">
				<div class="inner">
					@include('EmployeeInfo::em0020.leftcontent')
				</div>
			</div>
					...
					<div class="card-body p-0">
						<div class="row">
							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="right-respon">
								@include('EmployeeInfo::em0020.rightcontent')
							</div>
						</div>
					</div><!-- end .card-body -->
				</div><!-- end .card -->
