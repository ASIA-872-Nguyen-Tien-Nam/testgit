            ...
            <div class="wmd-view table-responsive-right table-responsive _width" style="max-height: 400px">
                @if (isset($disabled) && $disabled == '' && (isset($tab_04['disabled_tab04']) && $tab_04['disabled_tab04'] == ''))
                    <div class="full-width full-width-head">
                        <a href="javascript:;"
                            class="btn btn-primary btn-basic-setting-menu btn-issue btn-add-new-row-15" tabindex="9">
                            +
                        </a>
                    </div>
                @endif
                <div class="detail-content full-width">
                    @foreach ($tab_04['list_data_1'] as $index => $data)
                        <div class="row detail-sub detail {{ $index > 0 ? 'tr-head' : '' }}"
                            style="align-items: center;width: 100%;margin-left: 0px;background: #eaeaea;">
                            <div class="no-detail" style="width: 3.8%;">
                                <input type="text" class="detail_no"
                                    value="{{ $data['detail_no'] == 0 ? '' : $data['detail_no'] }}" hidden>
                            ...
                            <div class='row item-group' style="width: 95%">
                                @foreach ($data as $key => $item)
                                    ...
                                    @if (isset($row['item_id']) && $row['item_id'] == 1)
                                        <div class="list_item {{ $row['item_display_kbn'] == 1 ? 'list1_tab_04' : 'd-none' }}"
                                            style="width: 33%" id="li-1" col-size="2">
                                    ...
                                    @if (isset($row['item_id']) && $row['item_id'] == 2)
                                        <div class="option-item list_item {{ $row['item_display_kbn'] == 1 ? 'list1_tab_04' : 'd-none' }}"
                                            style="width: 16.5%" id="li-2" col-size="1">
                                            <div class="d-flex justify-content-between sort-li">
                                                <span class="ics-textbox num-length">
                                                    <input type="text"
                                                        class="form-control form-control-sm item_title"
                                            ...
                                            <span class="num-length p-item text-overfollow" data-container="body"
                                            data-toggle="tooltip" data-original-title="{{ $row['text_item'] ?? '' }}"
                                                >
                                                {{ $row['text_item'] ?? '' }}
                                            </span>
                                        </div>
                                    ...
                                    @if (isset($row['item_id']) && $row['item_id'] == 3)
                                        <div class="option-item list_item {{ $row['item_display_kbn'] == 1 ? 'list1_tab_04' : 'd-none' }}"
                                            style="width: 16.5%" id="li-3" col-size="1">
                                            <div class="d-flex justify-content-between sort-li">
                                                <span class="ics-textbox num-length">
                                                    <input type="text"
                                                        class="form-control form-control-sm item_title"
                                    ...
                                    @if (isset($row['item_id']) && $row['item_id'] == 4)
                                        <div class="list_item {{ $row['item_display_kbn'] == 1 ? 'list1_tab_04' : 'd-none' }}"
                                            style="width: 16.5%" id="li-4" col-size="1">
                                            <div class="d-flex justify-content-between sort-li">
                                                <span class="ics-textbox num-length">
                                                    <input type="text"
                                                        class="form-control form-control-sm item_title"
                                    ...
                                    @if (isset($row['item_id']) && $row['item_id'] == 5)
                                        <div class="list_item {{ $row['item_display_kbn'] == 1 ? 'list1_tab_04' : 'd-none' }}"
                                            style="width: 16.5%" id="li-5" col-size="1">
                                            <div class="d-flex justify-content-between sort-li">
                                                <span class="ics-textbox num-length">
                                                    <input type="text"
                                                        class="form-control form-control-sm item_title"
                                    ...
                                    @if (isset($row['item_id']) && $row['item_id'] == 6)
                                        <div class="list_item {{ $row['item_display_kbn'] == 1 ? 'list1_tab_04' : 'd-none' }}"
                                            style="width: 16.5%" id="li-6" col-size="1">
                                            <div class="d-flex justify-content-between sort-li">
                                                <span class="ics-textbox num-length">
                                                    <input type="text"
                                                        class="form-control form-control-sm item_title"
                                    ...
                                    @if (isset($row['item_id']) && $row['item_id'] == 7)
                                        <div class="list_item {{ $row['item_display_kbn'] == 1 ? 'list1_tab_04' : 'd-none' }}"
                                            style="width: 16.5%" id="li-7" col-size="1">
                                            <div class="d-flex justify-content-between sort-li">
                                                <span class="ics-textbox num-length">
                                                    <input type="text"
                                                        class="form-control form-control-sm item_title"
                                    ...
                                    @if (isset($row['item_id']) && $row['item_id'] == 8)
                                        <div class="list_item {{ $row['item_display_kbn'] == 1 ? 'list1_tab_04' : 'd-none' }}"
                                            style="width: 33%" id="li-8" col-size="2">
                                            <div class="d-flex justify-content-between sort-li">
                                                <span class="ics-textbox num-length">
                                                    <input type="text"
                                                        class="form-control form-control-sm item_title"
                                    ...
                                    @if (isset($row['item_id']) && $row['item_id'] == 9)
                                        <div class="list_item {{ $row['item_display_kbn'] == 1 ? 'list1_tab_04' : 'd-none' }}"
                                            style="width: 33%" id="li-9" col-size="2">
                                            <div class="d-flex justify-content-between sort-li">
                                                <span class="ics-textbox num-length">
                                                    <input type="text"
                                                        class="form-control form-control-sm item_title"
                                    ...
                                    @if (isset($row['item_id']) && $row['item_id'] == 10)
                                        <div class="list_item {{ $row['item_display_kbn'] == 1 ? 'list1_tab_04' : 'd-none' }}"
                                            style="width: 99%" id="li-10" col-size="6">
                                            <div class="d-flex justify-content-between sort-li">
                                                <span class="ics-textbox num-length">
                                                    <input type="text"
                                                        class="form-control form-control-sm item_title"
                                    ...
                                    @if (isset($row['item_id']) && $row['item_id'] == 11)
                                        <div class="list_item {{ $row['item_display_kbn'] == 1 ? 'list1_tab_04' : 'd-none' }}"
                                            style="width: 99%" id="li-11" col-size="6">
                                            <div class="d-flex justify-content-between sort-li">
                                                <span class="ics-textbox num-length">
                                                    <input type="text"
                                                        class="form-control form-control-sm item_title"
                                    ...
                                    @if (isset($row['item_id']) && $row['item_id'] == 12)
                                        ...
                                        @endphp
                                        <div class="list_item {{ $row['item_display_kbn'] == 1 ? 'list1_tab_04' : 'd-none' }}"
                                            style="width: 16.5%" id="li-12" col-size="1">
                                            <div class="d-flex justify-content-between sort-li">
                                                <span class="ics-textbox num-length">
                                                    <input type="text"
                                                        class="form-control form-control-sm item_title"
                                                ...
                                                @if (count($array[0]) == 3)
                                                    @foreach ($array ?? [] as $cb)
                                                        @if (($row['select_item'] ?? 0) == $cb['selected_items_no'])
                                                            <span class="num-length text-overfollow" data-container="body"
                                                                data-toggle="tooltip" data-original-title="{{ $cb['selected_items_nm'] ?? '' }}"
                                                            >
                                    ...
                                    @if (isset($row['item_id']) && $row['item_id'] == 13)
                                        ...
                                        @endphp
                                        <div class="list_item {{ $row['item_display_kbn'] == 1 ? 'list1_tab_04' : 'd-none' }}"
                                            style="width: 16.5%" id="li-13" col-size="1">
                                            <div class="d-flex justify-content-between sort-li">
                                                <span class="ics-textbox num-length">
                                                    <input type="text"
                                                        class="form-control form-control-sm item_title"
                                    ...
                                    @if (isset($row['item_id']) && $row['item_id'] == 14)
                                        ...
                                        @endphp
                                        <div class="option-item list_item {{ $row['item_display_kbn'] == 1 ? 'list1_tab_04' : 'd-none' }}"
                                            style="width: 16.5%" id="li-14" col-size="1">
                                            <div class="d-flex justify-content-between sort-li">
                                                <span class="ics-textbox num-length">
                                                    <input type="text"
                                                        class="form-control form-control-sm item_title"
                                    ...
                                    @if (isset($row['item_id']) && $row['item_id'] == 15)
                                        ...
                                        @endphp
                                        <div class="option-item list_item {{ $row['item_display_kbn'] == 1 ? 'list1_tab_04' : 'd-none' }}"
                                            style="width: 16.5%" id="li-15" col-size="1">
                                            <div class="d-flex justify-content-between sort-li">
                                                <span class="ics-textbox num-length">
                                                    <input type="text"
                                                        class="form-control form-control-sm item_title"
                                    ...
                                    @if (isset($row['item_id']) && $row['item_id'] == 16)
                                        ...
                                        @endphp
                                        <div class="option-item list_item {{ $row['item_display_kbn'] == 1 ? 'list1_tab_04' : 'd-none' }}"
                                            style="width: 16.5%" id="li-16" col-size="1">
                                            <div class="d-flex justify-content-between sort-li">
                                                <span class="ics-textbox num-length">
                                                    <input type="text"
                                                        class="form-control form-control-sm item_title"
                                    ...
                                    @if (isset($row['item_id']) && $row['item_id'] == 17)
                                        ...
                                        @endphp
                                        <div class="option-item list_item {{ $row['item_display_kbn'] == 1 ? 'list1_tab_04' : 'd-none' }}"
                                            style="width: 16.5%" id="li-17" col-size="1">
                                            <div class="d-flex justify-content-between sort-li">
                                                <span class="ics-textbox num-length">
                                                    <input type="text"
                                                        class="form-control form-control-sm item_title"
                                    ...
                                    @if (isset($row['item_id']) && $row['item_id'] == 18)
                                        ...
                                        @endphp
                                        <div class="option-item list_item {{ $row['item_display_kbn'] == 1 ? 'list1_tab_04' : 'd-none' }}"
                                            style="width: 16.5%" id="li-18" col-size="1">
                                            <div class="d-flex justify-content-between sort-li">
                                                <span class="ics-textbox num-length">
                                                    <input type="text"
                                                        class="form-control form-control-sm item_title"
                                    ...
                                    @if (isset($row['item_id']) && $row['item_id'] == 19)
                                        ...
                                        @endphp
                                        <div class="option-item list_item {{ $row['item_display_kbn'] == 1 ? 'list1_tab_04' : 'd-none' }}"
                                            style="width: 16.5%" id="li-19" col-size="1">
                                            <div class="d-flex justify-content-between sort-li">
                                                <span class="ics-textbox num-length">
                                                    <input type="text"
                                                        class="form-control form-control-sm item_title"
                                    ...
                                    {{-- @if (isset($row['item_id']) && $row['item_id'] == 20)
                                        ...
                                        @endphp
                                        <div class="option-item list_item {{ $row['item_display_kbn'] == 1 ? 'list1_tab_04' : 'd-none' }}"
                                            style="width: 16.5%" id="li-20" col-size="1">
                                            <div class="d-flex justify-content-between sort-li">
                                                <span class="ics-textbox num-length">
                                                    <input type="text"
                                                        class="form-control form-control-sm item_title"
                                    ...
                                    @if (isset($row['item_id']) && $row['item_id'] == 21)
                                        ...
                                        @endphp
                                        <div class="option-item list_item {{ $row['item_display_kbn'] == 1 ? 'list1_tab_04' : 'd-none' }}"
                                            style="width: 16.5%" id="li-21" col-size="1">
                                            <div class="d-flex justify-content-between sort-li">
                                                <span class="ics-textbox num-length">
                                                    <input type="text"
                                                        class="form-control form-control-sm item_title"
                                    ...
                                    @if (isset($row['item_id']) && $row['item_id'] == 22)
                                        <div class="option-item list_item {{ $row['item_display_kbn'] == 1 ? 'list1_tab_04' : 'd-none' }}"
                                            style="width: 16.5%" id="li-22" col-size="1">
                                            <div class="d-flex justify-content-between sort-li">
                                                <span class="ics-textbox num-length">
                                                    <input type="text"
                                                        class="form-control form-control-sm item_title"
                                            ...
                                            <span class="num-length p-item text-right" style="">
                                                {{ $row['number_item'] ?? '' }}
                                            </span>
                                        </div>
                                    @endif
                                    @if (isset($row['item_id']) && $row['item_id'] == 23)
                                        <div class="option-item list_item {{ $row['item_display_kbn'] == 1 ? 'list1_tab_04' : 'd-none' }}"
                                            style="width: 16.5%" id="li-23" col-size="1">
                                            <div class="d-flex justify-content-between sort-li">
                                                <span class="ics-textbox num-length">
                                                    <input type="text"
                                                        class="form-control form-control-sm item_title"
                                    ...
                                    @if (isset($row['item_id']) && $row['item_id'] == 24)
                                        <div class="option-item list_item {{ $row['item_display_kbn'] == 1 ? 'list1_tab_04' : 'd-none' }}"
                                            style="width: 16.5%" id="li-24" col-size="1">
                                            <div class="d-flex justify-content-between sort-li">
                                                <span class="ics-textbox num-length">
                                                    <input type="text"
                                                        class="form-control form-control-sm item_title"
                                    ...
                                    @if (isset($row['item_id']) && $row['item_id'] == 25)
                                        <div class="option-item list_item {{ $row['item_display_kbn'] == 1 ? 'list1_tab_04' : 'd-none' }}"
                                            style="width: 16.5%" id="li-25" col-size="1">
                                            <div class="d-flex justify-content-between sort-li">
                                                <span class="ics-textbox num-length">
                                                    <input type="text"
                                                        class="form-control form-control-sm item_title"
                                    ...
                                    @if (isset($row['item_id']) && $row['item_id'] == 26)
                                        <div class="list_item {{ $row['item_display_kbn'] == 1 ? 'list1_tab_04' : 'd-none' }}"
                                            style="width: 99%" id="li-26" col-size="6">
                                            <div class="d-flex justify-content-between sort-li">
                                                <span class="ics-textbox num-length">
                                                    <input type="text"
                                                        class="form-control form-control-sm item_title"
                                    ...
                                    @if (isset($row['item_id']) && $row['item_id'] == 27)
                                        <div class="list_item {{ $row['item_display_kbn'] == 1 ? 'list1_tab_04' : 'd-none' }}"
                                            style="width: 99%" id="li-27" col-size="6">
                                            <div class="d-flex justify-content-between sort-li">
                                                <span class="ics-textbox num-length">
                                                    <input type="text"
                                                        class="form-control form-control-sm item_title"
                                    ...
                                    @if (isset($row['item_id']) && $row['item_id'] == 28)
                                        <div class="list_item {{ $row['item_display_kbn'] == 1 ? 'list1_tab_04' : 'd-none' }}"
                                            style="width: 33%" id="li-28" col-size="2">
                                            <div class="d-flex justify-content-between sort-li">
                                                <span class="ics-textbox num-length">
                                                    <input type="text"
                                                        class="form-control form-control-sm item_title"
                                    ...
                                    @if (isset($row['item_id']) && $row['item_id'] == 29)
                                        <div class="list_item {{ $row['item_display_kbn'] == 1 ? 'list1_tab_04' : 'd-none' }}"
                                            style="width: 33%" id="li-29" col-size="2">
                                            <div class="d-flex justify-content-between sort-li">
                                                <span class="ics-textbox num-length">
                                                    <input type="text"
                                                        class="form-control form-control-sm item_title"
                                    ...
                                    @if (isset($row['item_id']) && $row['item_id'] == 30)
                                        <div class="list_item {{ $row['item_display_kbn'] == 1 ? 'list1_tab_04' : 'd-none' }}"
                                            style="width: 33%" id="li-30" col-size="2">
                                            <div class="d-flex justify-content-between sort-li">
                                                <span class="ics-textbox num-length">
                                                    <input type="text"
                                                        class="form-control form-control-sm item_title"
        ...
        <div class="col-md-12" style="margin-top : 10px">
            <div class="wmd-view table-responsive-right table-responsive _width" style="max-height: 400px">
                @if (isset($disabled) && $disabled == '' && (isset($tab_04['disabled_tab04']) && $tab_04['disabled_tab04'] == ''))
                    <div class="full-width full-width-head">
                        <a href="javascript:;"
                            class="btn btn-primary btn-basic-setting-menu btn-issue btn-add-new-row-15"
                            tabindex="9">
                            +
                        </a>
                    </div>
                                ...
                                @foreach ($data as $key => $item)
                                    ...
                                    @if (isset($row['item_id']) && $row['item_id'] == 6)
                                        <div class="list_item {{ $row['item_display_kbn'] == 1 ? 'list1_tab_04' : 'd-none' }}"
                                            ...
                                            <span class="num-length p-item text-overfollow" 
                                            data-container="body"
                                            data-toggle="tooltip" data-original-title="{{ $row['text_item'] ?? '' }}"    
                                            >
                                                {{ $row['text_item'] ?? '' }}
                                    ...
                                    @if (isset($row['item_id']) && $row['item_id'] == 25)
                                        <div class="option-item list_item {{ $row['item_display_kbn'] == 1 ? 'list1_tab_04' : 'd-none' }}"
                                            ...
                                            <span class="num-length p-item text-overfollow text-right" data-container="body"
                                            data-toggle="tooltip" data-original-title="{{ $row['number_item'] ?? '' }}"    
                                            >
                                                {{ $row['number_item'] ?? '' }}
                                            </span>
                                        </div>
