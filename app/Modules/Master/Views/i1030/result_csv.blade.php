                                     ...
                                     <div class="input-group-btn input-group div_employee_cd" style="max-width: 230px">
                                         <input type="hidden" class="rate" data-rater="1"/>
                                            <span class="num-length">
                                                ...
                                                <input type="text" class="form-control indexTab rate_emp rater_employee_nm_1 error_rater_emp_1  min-width" tabindex="1" maxlength="101" old_rater_employee_nm="{{ $row['rater_employee_nm_1'] }}"
                                     ...
                                     <div class="input-group-btn input-group div_employee_cd" style="max-width: 230px">
                                         <input type="hidden" data-rater="2"/>
                                            <span class="num-length">
                                                ...
                                                <input type="text" class="form-control indexTab rate_emp rater_employee_nm_2 error_rater_emp_2 min-width" id="employee_cd" tabindex="1" maxlength="101" old_rater_employee_nm="{{ $row['rater_employee_nm_2'] }}"
                                     ...
                                     <div class="input-group-btn input-group div_employee_cd" style="max-width: 230px">
                                         <input type="hidden" data-rater="3"/>
                                            <span class="num-length">
                                                ...
                                                <input type="text" class="form-control indexTab rate_emp rater_employee_nm_3 error_rater_emp_3 min-width"  id="employee_cd" tabindex="1" maxlength="101"  old_rater_employee_nm="{{ $row['rater_employee_nm_3'] }}"
                                     ...
                                     <div class="input-group-btn input-group div_employee_cd" style="max-width: 230px">
                                         <input type="hidden" data-rater="4"/>
                                            <span class="num-length">
                                                ...
                                                <input type="text" class="form-control indexTab rate_emp rater_employee_nm_4 error_rater_emp_4 min-width" id="employee_cd" tabindex="1" maxlength="101"  old_rater_employee_nm="{{ $row['rater_employee_nm_4'] }}"
                            ...
                            <td class="min-w200px  {{$row['classCheckFirstHidden']}}" rowspan="{{ $row['row'] }}">
                                <span class="num-length">
                                     <div class="input-group-btn input-group div_employee_cd" style="max-width: 230px">
                                            <span class="num-length">
                                                <input type="hidden" class="rater_employee_cd rater_employee_cd_1" value="{{ $row['rater_employee_cd_1'] }}" />
                                                <input type="text" class="form-control indexTab rate_emp rater_employee_nm_1  min-width" tabindex="1" maxlength="101" old_rater_employee_nm="{{ $row['rater_employee_nm_1'] }}"
                            ...
                            <td class="min-w200px  {{$row['classCheckFirstHidden']}}" rowspan="{{ $row['row'] }}">
                                <span class="num-length">
                                     <div class="input-group-btn input-group div_employee_cd" style="max-width: 230px">
                                            <span class="num-length">
                                                <input type="hidden" class="rater_employee_cd rater_employee_cd_2" value="{{ $row['rater_employee_cd_2'] }}" />
                                                <input type="text" class="form-control indexTab rate_emp rater_employee_nm_2 min-width" id="employee_cd" tabindex="1" maxlength="101" old_rater_employee_nm="{{ $row['rater_employee_nm_2'] }}"
                            ...
                            <td class="min-w200px  {{$row['classCheckFirstHidden']}}" rowspan="{{ $row['row'] }}">
                                <span class="num-length">
                                     <div class="input-group-btn input-group div_employee_cd" style="max-width: 230px">
                                            <span class="num-length">
                                                 <input type="hidden" class="rater_employee_cd rater_employee_cd_3" value="{{ $row['rater_employee_cd_3'] }}" />
                                                <input type="text" class="form-control indexTab rate_emp rater_employee_nm_3 " min-width id="employee_cd" tabindex="1" maxlength="101"  old_rater_employee_nm="{{ $row['rater_employee_nm_3'] }}"
                            ...
                            <td class="min-w200px  {{$row['classCheckFirstHidden']}}" rowspan="{{ $row['row'] }}"rowspan="{{ $row['row'] }}">
                                <span class="num-length">
                                     <div class="input-group-btn input-group div_employee_cd" style="max-width: 230px">
                                            <span class="num-length">
                                                 <input type="hidden" class="rater_employee_cd rater_employee_cd_4" value="{{ $row['rater_employee_cd_4'] }}" />
                                                <input type="text" class="form-control indexTab rate_emp rater_employee_nm_4  min-width" id="employee_cd" tabindex="1" maxlength="101"  old_rater_employee_nm="{{ $row['rater_employee_nm_4'] }}"
                    ...
                    <div class="input-group-btn input-group div_employee_cd" style="max-width: 230px">
                        <input type="hidden">
                                    <span class="num-length">
                                        ...
                                        <input type="text" class="form-control indexTab add_emp add_employee_cd error_rater_emp_5 min-width emp_nm ui-autocomplete-input" id="employee_cd" tabindex="4" maxlength="20" old_rater_employee_nm="" value="" style="padding-right: 40px;" autocomplete="off">
                                    </span>
                        <div class="input-group-append-btn">
                            <button class="btn btn-transparent btn_employee_cd_popup" type="button" tabindex="-1" rater="2">
                                <i class="fa fa-search"></i>
