	...
	<div class="col-md-12 col-xs-12 col-lg-12">
		<div class="list-search-v">
			...
			<div class="list-search-content">
				@forelse($list ?? [] as $row)
					<div class="text-overfollow list-search-child" id="{{ $row['organization_cd'] }}"  data-container="body" data-toggle="tooltip" data-original-title="{{$row['organization_nm']}}">{{$row['organization_nm']}}</div>
				@empty
