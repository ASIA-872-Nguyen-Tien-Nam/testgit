...
{!! public_url('template/css/form/s0020.index.css') !!}
@stop

@section('asset_footer')
    {!!public_url('template/js/form/s0020.index.js')!!}
@stop
