    ...
    <a href="javascript:void(0)" class="lv{{$level}} list_organization">
        <table class="ck-inline">
            <tr>
                ...
                <td class="lh-td" ><span class="text-overfollow" data-container="body" data-toggle="tooltip" data-original-title="{{$tmp['organization_nm']}}" ><label class="text-overfollow abc" for="{{$unique}}">{{$tmp['organization_nm']}}</label></span></td>
            </tr>
        </table>
    </a>
<?php }
