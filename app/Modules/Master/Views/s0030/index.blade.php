...
@section('asset_header')
        <!-- START LIBRARY CSS -->
    {!!public_url('template/css/form/s0030.index.css')!!}
@stop
@section('asset_footer')
    {!!public_url('template/js/form/s0030.index.js')!!}
        <!-- START LIBRARY JS -->
@stop
            ...
            <div class="row" style="margin-top: 10px;">
                ...
                <div class="col-md-8 col-lg-9 col-xl-10">
                    ...
                    <div style="text-align: right">
                        ...
                        <button id="btn-search" class="btn btn-primary focusin" tabindex="8">{{__('messages.extract_employee')}}</button>
                    </div>
                </div>
