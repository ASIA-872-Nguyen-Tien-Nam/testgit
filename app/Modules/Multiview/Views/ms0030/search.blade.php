...
<div class="table-responsive wmd-view  sticky-table sticky-headers sticky-ltr-cells">
    <table class="table sortable table-bordered table-hover" id="myTable">
        <thead>
        <tr>
            <th class="w-50px ">
            ...
            @php
            @endphp
            <th class="w-80px" style="min-width:150px">{{__('messages.employee_no')}}</th>
            <th class="w-160px">{{__('messages.employee_name')}}</th>
            <th class="w-160px invi_head" style="min-width:170px">{{__('messages.employee_classification')}}</th>
            ...
            <th class="w-120px ">{{__('messages.current_permissions')}}</th>
        </tr>
        </thead>
        <tbody>
