...
class OQ2032Controller extends Controller
{
      ...
      * @created at 2020-09-04 08:33:52
     ...
     public function index(Request $request)
     {
          ...
          $data['title'] = trans('messages.analysis_questionnaire_results');
          ...
          return view('OneOnOne::oq2032.index', $data);
     }
     ...
     public function postSearch(Request $request)
     {
          ...
          $params['mode']               =  0;
          $result = $this->analysisService->getQuestionnaireResult($params);
          if (isset($result[0][0]['error_typ']) && $result[0][0]['error_typ'] == '999') {
               return response()->view('errors.query', [], 501);
          }
          $data['list']                 =  $result[0] ?? [];
          $data['header']               =  $result[1] ?? [];
          $data['view_unit']           =  $data_request['view_unit'] ?? 0;     // 0.全社 1.部署 2.職種 3.等級 4.年齢
          // render view
          if ($request->ajax()) {
               return view('OneOnOne::oq2032.search', $data);
          } else {
               return $data;
          }
     }
     ...
     public function postExportExcel(Request $request)
     {
          if ($request->ajax()) {
               ...
               try {
                    ...
                    //
                    $store_name = 'SPC_oQ2032_FND1';
                    $typeReport = 'FNC_OUT_EXL';
                    $screen = 'OQ2032';
                    $file_name = 'OQ2032_' . time() . '.xlsx';
                    ...
                    if (session_data()->language == 'en') {
                         $name = 'Analysis_QuestionnaireResults_';
                    }
