...
<!-- START LIBRARY JS -->
{!!public_url('template/js/oneonone/oq2030/oq2030.index.js')!!}
@stop
@push('asset_button')
{!!
...
<div class="container-fluid">
					...
					<div class="col-sm-6 col-md-3 col-lg-2">
						<div class="form-group ln-white-text">
							...
							<div class="multi-select-full">
								<select id="group_cd_1on1" tabindex="2" class="form-control multiselect group_cd" multiple="multiple">
				...
				<div class="row">
					<div class="col-sm-6 col-md-3 col-xl-2">
						<div class="form-group">
							...
							<select id="position_cd" tabindex="4" class="form-control ">
					...
					<div class="col-sm-6 col-md-3 col-xl-2">
						<div class="form-group">
							...
							<select id="job_cd" tabindex="5" class="form-control ">
								<option value="-1"></option>
							...
							<div class="input-group-btn input-group div_employee_cd">
								<div class="form-group text-right">
									<div class="full-width">
										<a href="javascript:;" id="btn_search" class="btn btn-outline-primary" tabindex="9">
											<i class="fa fa-search"></i>
											{{__('messages.search')}}
										</a>
									</div><!-- end .full-width -->
	...
	<div class="card">
		<div class="card-body" id="result" style="padding-bottom: 1.25rem !important;">
			@include('OneOnOne::oq2030.search')
		</div><!-- end .card-body -->
	</div><!-- end .card -->
	@endif
