    ...
    <div class="col-md-12">
        <div id="topTable" class="wmd-view table-responsive _width" style="background-attachment: fixed;max-height: 500px;margin-top: 10px;">
            <table class="table table-bordered table-hover table_sort one-table table-special ofixed-boder" id="table-data" style="margin-bottom: 10px;">
                <thead>
                    <tr>
                        <th class="th_view_unit" style="max-width:200px; min-width:150px">{{__('messages.department')}}</th>
                ...
                <tbody>
                    ...
                    {{-- when choie $view_unit = 0.全社 then dont show this --}}
                    @if($view_unit != 0)
                        @foreach($list as $row)
                        <tr>
                    ...
                    <tr>
                        ...
                        @endif
                        <!-- annual_average -->
                        <td class="text-center">{{ $header[0]['averaged_point_year'] }}</td>
                    </tr>
                    @else
