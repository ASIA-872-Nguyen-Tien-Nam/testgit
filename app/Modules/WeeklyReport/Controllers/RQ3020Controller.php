...
class RQ3020Controller extends Controller
{
    /**WeeklyReportService */
    ...
    public function index(Request $request)
    {
        ...
        return view('WeeklyReport::rq3020.index', $data);
    }
    ...
    public function postSearch(Request $request)
    {
        ...
        $reports = $this->analysis_service->getAdequacyAnalysis($json, 0);
        $data['list']                 =  $reports[0] ?? [];
        $data['header']               =  $reports[1] ?? [];
        //return request ajax
        return view('WeeklyReport::rq3020.search', $data);
    }
    ...
    public function postExportExcel(Request $request)
    {
        if ($request->ajax()) {
            ...
            try {
                ...
                //
                $store_name = 'SPC_rQ3020_FND1';
                $typeReport = 'FNC_OUT_EXL';
                $screen = 'RQ3020';
                $file_name = 'Rq3020_' . time() . '.xlsx';
                ...
                if (session_data()->language == 'en') {
                    $name = 'Analysis_Satisfaction_Level_';
                }
