...
class RQ3030Controller extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('WeeklyReport::rq3030.index', $data);
    }
    /**
     * Search
     * @author nghianm
    ...
    public function postSearch(Request $request)
    {
        ...
        $reports = $this->analysis_service->getReactionAnalysis($json, 0);
        $data['list']                 =  $reports[0] ?? [];
        $data['header']               =  $reports[1] ?? [];
        //return request ajax
        return view('WeeklyReport::rq3030.search', $data);
    }
    /**
    ...
    public function postExportExcel(Request $request)
    {
        if ($request->ajax()) {
            ...
            try {
                ...
                //
                $store_name = 'SPC_rQ3030_FND1';
                $typeReport = 'FNC_OUT_EXL';
                $screen = 'RQ3030';
                $file_name = 'Rq3030_' . time() . '.xlsx';
