...
@section('asset_header')
    <!-- START LIBRARY CSS -->
    {!! public_url('template/css/weeklyreport/ri1020/ri1020.index.css') !!}
@stop
...
@section('asset_footer')
    ...
    {!! public_url('template/js/weeklyreport/ri1020/ri1020.index.js') !!}
@stop
@push('asset_button')
    {!! Helper::dropdownRenderWeeklyReport(['sendButton', 'backButton']) !!}
@endpush
@section('content')
    <!-- START CONTENT -->
    <div class="container-fluid">
        ...
        <div class="card">
            @include('WeeklyReport::ri1020.header_content')
        </div><!-- end .card -->
                        ...
                        <div class="form-group">
                            <div class="full-width text-right">
                                ...
                                <a href="javascript:;" class="btn btn-key-primary vt-3" id="btn_evaluation_import"
                                    ...
                                    {{ __('ri1020.input_data') }}
                                </a>
                                <a href="javascript:;" class="btn btn-key-primary vt-3" id="btn_apply_latest"
                                    tabindex="9">
                                    <i class="fa fa-check"></i>
                                    {{ __('ri1020.apply_flow') }}
                                </a>
                            </div><!-- end .full-width -->
                        </div>
                    </div>
        ...
        <!-- <div class="row mg_row"> -->
        <div id="card_import" class="card" style="padding: 16px">
            <div class="card-body">
                <div id="result">
                    @include('WeeklyReport::ri1020.list_content')
                </div>
            </div><!-- end .card -->
        </div>
                ...
                <table class="table sortable table-bordered table-hover fixed-header" id="table_result">
                    <thead>
                        <tr>
                            ...
                            <!-- <th class="min-w90px {{ isset($list[0]) ? $Rater['Rater1'] : '' }}"> -->
                            <th class="min-w90px">
                                {{ __('messages.1st_rater') }}</th>
                            <th class="min-w90px ">
                                {{ __('messages.2nd_rater') }}</th>
                            <th class="min-w90px ">
                                {{ __('messages.3rd_rater') }}</th>
                            <th class="min-w90px ">
                                {{ __('messages.4th_rater') }}</th>
    ...
    <template id="row2">
        <tr class="tr_first tr-odd" row_emp="">
            ...
            <td class="col15">
                <select name="" id="" class="form-control input-sm err_sheet_cd sheet_cd_b"
                    sheet_cd_f0032="{-{  $row['sheet_cd_f0032'] }-}">
    ...
    <template id="refer-row">
        <tr class="tr_first tr-odd first-em-cd" row_emp="">
            ...
            <td class="min-w200px col10" rowspan="">
                <span class="num-length">
                    <div class="input-group-btn input-group div_employee_cd" style="max-width: 230px">
                        <span class="num-length">
                            <input type="hidden" class="rater_employee_cd rater_employee_cd_1"
                                value="{-{ $row['rater_employee_cd_1'] }-}" />
                            <input type="tel"
                                class="form-control indexTab rate_emp rater_employee_nm_1 error_rater_emp_1 min-width"
                                tabindex="1" maxlength="101" old_rater_employee_nm="" value=""
                ...
                <span class="num-length">
                    <div class="input-group-btn input-group div_employee_cd" style="max-width: 230px">
                        <span class="num-length">
                            ...
                            <input type="tel"
                                class="form-control indexTab rate_emp rater_employee_nm_2 error_rater_emp_2 min-width"
                                id="employee_cd" tabindex="1" maxlength="101" old_rater_employee_nm="" value=""
                                style="padding-right: 40px;" />
                        </span>
                        <div class="input-group-append-btn">
                            <button class="btn btn-transparent btn_employee_cd_popup" type="button" tabindex="-1"
                ...
                <span class="num-length">
                    <div class="input-group-btn input-group div_employee_cd" style="max-width: 230px">
                        <span class="num-length">
                            ...
                            <input type="tel"
                                class="form-control indexTab rate_emp rater_employee_nm_3 error_rater_emp_3" min-width
                                id="employee_cd" tabindex="1" maxlength="101" old_rater_employee_nm="" value=""
                                style="padding-right: 40px;" />
                        </span>
                        <div class="input-group-append-btn">
                ...
                <span class="num-length">
                    <div class="input-group-btn input-group div_employee_cd" style="max-width: 230px">
                        <span class="num-length">
                            ...
                            <input type="tel"
                                class="form-control indexTab rate_emp rater_employee_nm_4 error_rater_emp_4 min-width"
                                id="employee_cd" tabindex="1" maxlength="101" old_rater_employee_nm="" value=""
                                style="padding-right: 40px;" />
                        </span>
                        <div class="input-group-append-btn">
            ...
            <td class="col15 col-x">
                <select name="" id="" class="form-control input-sm err_sheet_cd sheet_cd_a"
                    sheet_cd_f0032="">
                    <option value="-1"></option>
                </select>
            </td>
