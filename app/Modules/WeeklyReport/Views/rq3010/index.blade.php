...
@section('asset_header')
    <!-- START LIBRARY CSS -->
    {!! public_url('template/css/weeklyreport/rq3010/rq3010.index.css') !!}
@stop
@section('asset_footer')
    {!! public_url('template/js/weeklyreport/rq3010/rq3010.index.js') !!}
    <!-- START LIBRARY JS -->
@stop
    ...
    <div class="container-fluid">
            ...
            <div class="card-body">
                ...
                <div class="group-search-condition">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-lg-3 col-xl-2">
                            <div class="form-group">
                                <label style="white-space: nowrap">{{ __('rm0200.report_type') }}</label>
                                <div class="multi-select-full">
                                    <select id="report_kind" tabindex="3" class="form-control multiselect"
                                        multiple="multiple">
                                        @isset($report_kinds)
        ...
        <div class="card">
            <div class="card-body" id="result">
                @include('WeeklyReport::rq3010.search')
            </div><!-- end .card-body -->
        </div><!-- end .card -->
