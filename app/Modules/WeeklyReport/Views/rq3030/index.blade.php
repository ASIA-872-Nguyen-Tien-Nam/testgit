...
@section('asset_footer')
    {!! public_url('template/js/weeklyreport/rq3030/rq3030.index.js') !!}
    <!-- START LIBRARY JS -->
@stop
    ...
    <div class="container-fluid">
            ...
            <div class="card-body">
                ...
                <div class="group-search-condition">
                    <div class="row div_month_times">
                        ...
                        <div class="col-md-4 col-lg-3 col-xl-2 col-6 row div_month_time_s">
                            <div class="col-6" style="padding-left:10px;padding-right:5px">
                                <div class="form-group">
                                    ...
                                    <select name="month_from" id="month_from" class="form-control employee_role month_times"
                                        tabindex="2" disabled>
                                        <option value="-1"></option>
                                        {{-- @for ($i = 1; $i <= 12; $i++)
                                            <option value="{{$i}}">{{ $i }}{{ __('rq3020.month_after') }}
                                            </option>
                                        @endfor --}}
                                    </select>
                                </div>
                            ...
                            <div class="col-6 pr-0">
                                <div class="form-group">
                                    ...
                                    <select name="times_from" id="times_from" class="form-control employee_role times"
                                        tabindex="2" disabled>
                                        <option value="-1"></option>
                                    </select>
                                </div>
                        ...
                        <div class="col-md-4 col-lg-3 col-xl-2 col-6 row div_month_time_s">
                            <div class="col-6" style="padding-left:0px;padding-right:15px">
                                <div class="form-group">
                                    <label class="control-label">{{ __('rq3020.month') }}</label>
                                    <select name="month_to" id="month_to" class="form-control employee_role month_times"
                                        tabindex="2" disabled>
                                        <option value="-1"></option>
                                        {{-- @for ($i = 1; $i <= 12; $i++)
                                            <option value="{{$i}}">{{ $i }}{{ __('rq3020.month_after') }}
                            ...
                            <div class="col-6 pl-0" style="padding-right: 15px;">
                                <div class="form-group">
                                    <label class="control-label">{{ __('rq3020.times') }}</label>
                                    <select name="times_to" id="times_to" class="form-control employee_role times"
                                        tabindex="2" disabled>
                                        <option value="-1"></option>
                                    </select>
                                </div>
                        ...
                        <div class="col-md-4 col-lg-3 col-xl-2">
                            <div class="form-group">
                                <label class="control-label lb-required" lb-required="{{ __('messages.required') }}">{{ __('rq3020.report_type') }}</label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-lg-3 col-xl-2">
                            <div class="form-group">
                                <label class="control-label">{{ __('rq3030.reader') }}</label>
                                <div class="input-group-btn input-group div_employee_cd">
                                    <span class="num-length">
                                        <input type="hidden" class="employee_cd_hidden viewer_cd" id="viewer_cd"
                                            value="">
                                        <input type="text" fiscal_year_weeklyreport="{{ $fiscal_year_today ?? 0 }}"
                                            id="viewer_employee_nm"
                                            class="form-control indexTab employee_nm_weeklyreport ui-autocomplete-input"
                                            tabindex="3" maxlength="101" value="" autocomplete="off">
                                    </span>
                                    <div class="input-group-append-btn">
        ...
        <div class="card">
            <div class="card-body" id="result">
                @include('WeeklyReport::rq3030.search')
            </div><!-- end .card-body -->
        </div><!-- end .card -->
