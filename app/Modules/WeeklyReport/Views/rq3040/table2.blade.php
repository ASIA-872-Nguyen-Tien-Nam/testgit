        ...
        <table class="table one-table sortable table-bordered table-hover ofixed-boder" id="table2">
            <thead>
                <tr>
                    ...
                    <th class="w-120px" colspan="10">{{__('rq3040.reactions')}}</th>
                    @endif
                </tr>
                <tr>
                    @if(isset($remark))
                    @php
                    if(isset($remark[0]['point'])){
            ...
            <tbody>
                ...
                @for($i = 90 ;$i >= 0;$i-=10)
                    ...
                    if(($data_detail['sub_total']) > 0){
                        $point_average = round(((($data_detail['item_no_1']*$point_typ_1) + ($data_detail['item_no_2']*$point_typ_2) + ($data_detail['item_no_3']*$point_typ_3) + ($data_detail['item_no_4']*$point_typ_4))/($data_detail['sub_total'])),2);
                    }  
                    @endphp
                <tr class="">
                    @if ($i===90)
