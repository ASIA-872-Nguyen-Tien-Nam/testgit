        ...
        <table class="table one-table sortable table-bordered table-hover ofixed-boder" id="table4">
            <thead>
                <tr>
                    ...
                    @if ($combination == 23)
                        <th colspan="11">{{__('rq3040.reactions')}}</th>
                    @elseif($combination == 32)
                        <th colspan="11">{{__('messages.adequacy')}}</th>
                    @endif
                </tr>
                <tr>
                    @if(isset($remark_reactions))
                    @php
                    if(isset($remark_reactions[0]['point'])){
                    $point_typ_1 = $remark_reactions[0]['point'];
                    }
                    if(isset($remark_reactions[1]['point'])){
                    $point_typ_2 = $remark_reactions[1]['point'];
                    }
                    if(isset($remark_reactions[2]['point'])){
                    $point_typ_3 = $remark_reactions[2]['point'];
                    }
                    if(isset($remark_reactions[3]['point'])){
                    $point_typ_4 = $remark_reactions[3]['point'];
                    }
                    @endphp
                    @foreach ($remark_reactions as $row)
