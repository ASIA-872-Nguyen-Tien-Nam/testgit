...
{!! public_url('template/css/weeklyreport/rs0020/index.css') !!}
@stop

@section('asset_footer')
    {!!public_url('template/js/weeklyreport/rs0020/rs0020.index.js')!!}
@stop
