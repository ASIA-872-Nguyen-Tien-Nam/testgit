            ...
            <tr>
                <td class="td1-level{{$level}}">
                    <label for="{{$unique}}" class="lbl-text no checkbox-set container">
                        <input class="check-level-{{$level}} authority {{preg_replace('/\s+/', '', $tmp['selector'])}}" id="{{$unique}}" value="1" type="checkbox" tabindex="69">
                ...
                <td><span class="text-overfollow" data-container="body" data-toggle="tooltip" data-original-title="{{$tmp['organization_nm']}}" ><label style="display:block" class="text-overfollow" for="{{$unique}}">{{$tmp['organization_nm']}}</label></span></td>
            </tr>
        </table>
    </a>
<?php }
...
<div class="row">
    ...
    <div class="col-md-7 col-lg-4 col-xl-4">
        ...
        <label class="container lbl-text" for="use_typ" style="margin: 0;">{{__('messages.label_002')}}
...
<div class="row">
    <div class="col-md-12 col-lg-6 col-lg-6">
        <div class="row ln-authority" language="{{__('messages.language')}}">
            <div class="col-md-12 col-lg-12 col-xl-4 col-sm-6 ">
                <p>{{__('messages.set_functions_authority ')}}</p>
            </div>

            <div class="col-md-12 col-lg-12 col-xl-8 col-sm-6 div-reflect" style="justify-content: end;">
                <p><button id="btn-reflect" class="btn  one-btn focusin button-1on1 " tabindex="4">{{__('messages.batch_reflect')}}</button></p>
                <div class="form-group">
        ...
        <div class="table-responsive wmd-view  table-data">
            <table class="table table-bordered table-hover table-striped ofixed-boder">
                <thead>
                <tr>
    ...
    <div class="col-md-12 col-lg-6 col-lg-6 ln-12">
        ...
        <label class="container lbl-text" for="organization_belong_person_typ" style="margin: 0;">{{__('messages.label_001')}}
            <input name="organization_belong_person_typ" id="organization_belong_person_typ" value="0" type="checkbox" tabindex="4">
            <span class="checkmark"></span>
        </label>
        <div class="table-responsive table table-data table-hover one-table" id="table-organization">
            <ul>
                @if (!empty($lvl1))
