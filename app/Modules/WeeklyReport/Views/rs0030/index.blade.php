...
@section('asset_header')
        <!-- START LIBRARY CSS -->
    {!!public_url('template/css/weeklyreport/rs0030/s0030.index.css')!!}
@stop
@section('asset_footer')
    {!!public_url('template/js/weeklyreport/rs0030/s0030.index.js')!!}
        <!-- START LIBRARY JS -->
@stop

@push('asset_button')
{!!
	Helper::dropdownRenderWeeklyReport(['saveButton','delButton', 'backButton'])
!!}
@endpush
...
<div class="container-fluid">
    <div class="card">
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-lg-3 col-xl-2">
                    <div class="form-group">
                        ...
                        <select tabindex="4" name="position_cd" id="position_cd" class="form-control employee_typ">
                            <option value="0"></option>
                            @if(isset($data_init[2][0]))
                                @if($data_init[2][0]['position_cd'] !='')
                ...
                @foreach($organization_group as $item)
                    @if($item['organization_step'] == 1 )
                        <div class="col-md-4 col-xl-2 col-xs-12 col-lg-3">
                            <div class="form-group">
                                ...
                                <select system="5" id="organization_step{{$item['organization_step']}}" organization_typ="{{$item['organization_typ']}}" tabindex="5" class="form-control  organization_cd1" >
                                    <option value="-1"></option>
                                    @isset($combo_organization)
                                        @foreach($combo_organization as $temp)
                                            @isset($temp['organization_cd_1'])
                    ...
                    @else
                        <div class="col-md-4 col-xl-2 col-xs-12 col-lg-3">
                            <div class="form-group">
                                <div class="text-overfollow multi-select-lb" data-container="body" data-toggle="tooltip" data-original-title="{{$item['organization_group_nm']}}" style="margin-bottom: .5rem;">{{$item['organization_group_nm']}}</div>
                                <select system="5" id="organization_step{{$item['organization_step']}}" organization_typ="{{$item['organization_typ']}}" tabindex="5" class="form-control  organization_cd{{$item['organization_step']}}">
                                </select>
                            </div>
                        </div>
                    @endif
                ...
                <div class="col-md-8 col-lg-9 col-xl-10">
                    ...
                    <div style="text-align: right">
                        <div id="bor_authority" class="md-checkbox-v2 inline-block bor_authority" style="margin-right: 10px;">
                            <label class="container" for="check_authority">{{__('messages.unconfigured_employees_rs0030')}}
            ...
            <div id="result">
                @include('WeeklyReport::rs0030.search')
            </div>
        </div> <!-- end .card-body -->
    </div><!-- end .card -->
