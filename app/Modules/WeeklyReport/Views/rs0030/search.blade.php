...
<div class="table-responsive wmd-view  sticky-table sticky-headers sticky-ltr-cells one-table">
    <table class="table sortable table-bordered table-hover one-table ofixed-boder" id="myTable">
        <thead>
        <tr>
            <th class="w-50px ">
            ...
            @php
            @endphp
            <th class="text-overfollow" >{{__('messages.employee_no')}}</th>
            ...
            <th class="w-160px" data-container="body" >{{__('messages.current_permissions')}}</th>
        </tr>
        </thead>
        <tbody>
                ...
                <tr class="tr_employee">
                    <td class="text-center w-50px">
                        <div class="md-checkbox-v2 inline-block ck-nolabel">
                            <label for="ck{{$row['id']}}" class="container checkbox-os0030-body">
