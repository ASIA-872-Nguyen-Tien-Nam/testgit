...
--*　更新内容/update content		:	
--****************************************************************************************
CREATE PROCEDURE [SPC_Q2030_FND3]
...
BEGIN
	...
	INSERT INTO #M0030
	SELECT 
		ISNULL(M0030.company_cd,0)
	,	ISNULL(M0030.job_cd,0)
	...
	BEGIN
		...
		FROM #M0030 
		LEFT JOIN F0201 ON (
			#M0030.company_cd				=	F0201.company_cd
		AND F0201.fiscal_year				=	@P_fiscal_year
		AND #M0030.employee_cd				=	F0201.employee_cd
		AND F0201.treatment_applications_no	=	@P_treatment_applications_no
		AND F0201.del_datetime IS NULL
		)
	END
	...
	BEGIN
		...
		FROM #M0030 
		LEFT JOIN F0200 ON (
			#M0030.company_cd				=	F0200.company_cd
		AND @P_fiscal_year					=	F0200.fiscal_year
		AND #M0030.employee_cd				=	F0200.employee_cd
	...
	FROM #MAIN
	LEFT JOIN M0030 ON (
		#MAIN.company_cd		=	M0030.company_cd
	AND #MAIN.job_cd			=	M0030.job_cd
	AND M0030.del_datetime IS NULL
	)
	GROUP BY
		#MAIN.company_cd
	...
	AND #MAIN.job_cd		=	#GROUP.group_cd
	)
	GROUP BY 
		#MAIN.company_cd
	,	#MAIN.job_cd	
