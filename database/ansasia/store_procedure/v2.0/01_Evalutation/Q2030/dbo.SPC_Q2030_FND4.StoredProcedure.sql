...
--****************************************************************************************
CREATE PROCEDURE [SPC_Q2030_FND4]
...
BEGIN
	...
	INSERT INTO #M0050
	SELECT 
		ISNULL(M0050.company_cd,0)
	,	ISNULL(M0050.grade,0)
	...
	BEGIN
		...
		FROM #M0050 
		LEFT JOIN F0201 ON (
			#M0050.company_cd				=	F0201.company_cd
		AND F0201.fiscal_year				=	@P_fiscal_year
		AND #M0050.employee_cd				=	F0201.employee_cd
		AND F0201.treatment_applications_no	=	@P_treatment_applications_no
		AND F0201.del_datetime IS NULL
		)
	END
	...
	BEGIN
		...
		FROM #M0050 
		LEFT JOIN F0200 ON (
			#M0050.company_cd				=	F0200.company_cd
		AND @P_fiscal_year					=	F0200.fiscal_year
		AND #M0050.employee_cd				=	F0200.employee_cd
	...
	FROM #MAIN
	LEFT JOIN M0050 ON (
		#MAIN.company_cd		=	M0050.company_cd
	AND #MAIN.grade				=	M0050.grade
	AND M0050.del_datetime IS NULL
	)
	GROUP BY
		#MAIN.company_cd
