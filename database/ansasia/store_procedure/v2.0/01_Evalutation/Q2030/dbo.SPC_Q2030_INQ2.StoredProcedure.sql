...
--****************************************************************************************
CREATE PROCEDURE [SPC_Q2030_INQ2]
...
BEGIN
	...
	BEGIN
		...
		,	ISNULL(#M0070H.belong_cd3,'')
		,	ISNULL(#M0070H.belong_cd4,'')
		,	ISNULL(#M0070H.belong_cd5,'')
		...
		LEFT JOIN #M0070H ON (
			#AUTHORITY.company_cd	=	#M0070H.company_cd
		AND	#AUTHORITY.employee_cd	=	#M0070H.employee_cd
		)
		LEFT OUTER JOIN (
			SELECT 
