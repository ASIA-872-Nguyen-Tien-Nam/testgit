...
--*　更新内容/update content		:	
--****************************************************************************************
CREATE PROCEDURE [dbo].[SPC_S0030_INQ1]
...
BEGIN
	...
	SET @countAuthority = (SELECT COUNT(*) FROM S0022 WHERE S0022.company_cd = @P_company_cd AND S0022.authority_cd = @P_authority_cd AND S0022.authority	= 1)
	CREATE TABLE #M0071(
		company_cd			INT	
	...
	INSERT INTO #M0071
		...
		AND	M0071.belong_cd2	= M0020_1.organization_cd_2
		AND	M0071.belong_cd3	= M0020_1.organization_cd_3
		AND	M0071.belong_cd4	= M0020_1.organization_cd_4
		AND	M0071.belong_cd5	= M0020_1.organization_cd_5
		...
		AND	M0071.belong_cd3	= M0020_2.organization_cd_3
		AND	M0071.belong_cd4	= M0020_2.organization_cd_4
		AND	M0071.belong_cd5	= M0020_2.organization_cd_5
		)
	...
	　AND	M0020.organization_cd_5	= 	S0022.organization_cd_5
	 ...
	 AND	(@P_authority_typ <> 3 OR (@P_authority_typ =3 AND	((S0022.authority	= 1 AND @countAuthority > 0) OR @countAuthority = 0)))
	...
	WHERE
		(M0020.company_cd				=	@P_company_cd)
	AND	(@P_authority_typ <> 3 OR (@P_authority_typ =3 AND	S0022.authority	= 1))
	AND	(M0020.del_datetime				IS NULL)
	...
	,	M0020.organization_cd_5
	 ...
	 --[3]
	 SELECT 
		S0020.authority_cd					AS authority_cd
	 ,	ISNULL(S0020.authority_nm,'')		AS authority_nm
	 FROM S0020 WITH(NOLOCK)
	 WHERE (S0020.company_cd	 = @P_company_cd)
	 AND  (S0020.del_datetime IS NULL)
	 ORDER BY 
		S0020.arrange_order	ASC
	,	S0020.authority_cd
