DROP PROCEDURE [SPC_oS0030_INQ1]
GO
SET ANSI_NULLS ON
GO
...
--****************************************************************************************
CREATE PROCEDURE [dbo].[SPC_oS0030_INQ1]
...
BEGIN
	...
	SET @countAuthority = (
		SELECT COUNT(S2022.authority_cd) 
		FROM S2022
		WHERE 
			S2022.company_cd	= @P_company_cd 
		AND S2022.authority_cd	= @P_authority_cd 
		AND S2022.authority		= 1
		AND S2022.del_datetime IS NULL
	)
	--[0]
	SELECT 
	...
	LEFT OUTER JOIN S2022 WITH(NOLOCK) ON(
		M0020.company_cd		=	S2022.company_cd
	AND	@P_authority_cd			= 	S2022.authority_cd
	AND	M0020.organization_cd_1	= 	S2022.organization_cd_1
	AND	M0020.organization_cd_2	= 	S2022.organization_cd_2
	AND	M0020.organization_cd_3	= 	S2022.organization_cd_3
	AND	M0020.organization_cd_4	= 	S2022.organization_cd_4
	AND	M0020.organization_cd_5	= 	S2022.organization_cd_5
	AND	S2022.del_datetime		IS NULL
	)
	 WHERE 
			(M0020.company_cd		= @P_company_cd)
	 AND	(M0020.organization_typ = 1)
	 AND	(@P_authority_typ <> 3 OR (@P_authority_typ =3 AND	((S2022.authority	= 1 AND @countAuthority > 0) OR @countAuthority = 0)))
	...
	WHERE
		(M0020.company_cd				=	@P_company_cd)
	AND	(@P_authority_typ <> 3 OR (@P_authority_typ =3 AND	S2022.authority	= 1))
	AND	(M0020.del_datetime				IS NULL)
	...
	,	M0020.organization_cd_5
	 ...
	 --[3]
	 SELECT 
		S2020.authority_cd					AS authority_cd
	 ,	ISNULL(S2020.authority_nm,'')		AS authority_nm
	 FROM S2020 WITH(NOLOCK)
	 WHERE (S2020.company_cd	 = @P_company_cd)
	 AND  (S2020.del_datetime IS NULL)
	 ORDER BY 
		S2020.arrange_order	ASC
	,	S2020.authority_cd
