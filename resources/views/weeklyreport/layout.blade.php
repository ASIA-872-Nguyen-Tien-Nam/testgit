...
<head>
    ...
    {!! public_url('template/css/weeklyreport/common/weeklyreport.css') !!}
...
<body>
    @php
        ...
        $navbars = navbar_group($excepts, [4, 999]);
        // dd($navbars);
        // customer mirac
            ...
            <div class="col-8" style="display:flex">
                @isset(session_data()->m0070->mypurpose_use_typ)
                    @if (session_data()->m0070->mypurpose_use_typ == 1)
                        ...
                        <button class="btn btn-outline-primary my_purpose_btn" mode="5"
        ...
        <div class="" style="width:100%">
            <div class="col-12" style="padding: 0px">
                <div class="collapse navbar-collapse menu-common" id="navbarSupportedContent">
                    <div class="row menu-mb" style="width:100%;margin:0 auto">
                        <div class="col-6">
                                    ...
                                    @foreach ($navbars as $key => $row)
                                        @if ($key == 0 && count($row) == 1)
                                            <li class="nav-item">
                                                <a class="nav-link active" aria-current="page"
                                                    href="{{ url($row[0]->function_id) }}">
                                                    <span><img class="pictute-menu-common"
                                                            src={!! public_url('uploads/ver1.7/icon/icon-home.svg') !!}></span>
                                                    {{ __('messages.home') }}
                                                </a>
                                            </li>
                                        @elseif($contract_company_attribute == 1 && $key == 1)
                                            <li class="nav-item nav-item-common" data-toggle="collapse"
                                                ...
                                                <a class="nav-link" href="#">
                                                    <img class="pictute-menu-common"
                                                        src={!! public_url('template/image/icon/icon_2_write.png') !!}>1on1<span>
                                        ...
                                        @elseif ($key == 1)
                                            <li class="nav-item nav-item-common" data-toggle="collapse"
                                                href="#collapseExample1" role="button" aria-expanded="false"
                                                aria-controls="collapseExample1">
                                                <a class="nav-link" href="#"><img style=""
                                                        class="pictute-menu-common" src={!! public_url('uploads/ver1.7/icon/icon-enforce.svg') !!}>
                                                    {{ __('messages.implement') }} <span><i
                                        ...
                                        @elseif($contract_company_attribute == 1 && $key == 2)
                                            <li class="nav-item nav-item-common" data-toggle="collapse"
                                                ...
                                                <a class="nav-link" href="#"><img style=""
                                                        class="pictute-menu-common" src={!! public_url('template/image/icon/icon4.png') !!}>
                                                    {{ __('messages.weekly_master') }} <span><i
                                        ...
                                        @elseif ($key == 2)
                                            <li class="nav-item nav-item-common" data-toggle="collapse"
                                                ...
                                                aria-controls="collapseExample2">
                                                <a class="nav-link" href="#"><img style=""
                                                        class="pictute-menu-common" src={!! public_url('uploads/ver1.7/icon/icon-search.svg') !!}>
                                                    {{ __('messages.analysis') }} <span><i
                                                            class="fa fa-chevron-right"></i></a>
                                            </li>
                                            <ul class="nav flex-column">
                                                <div class="collapse menu-child-common" id="collapseExample2">
                                        ...
                                        @elseif($contract_company_attribute == 1 && $key == 3)
                                            <li class="nav-item nav-item-common" data-toggle="collapse"
                                                ...
                                                <a class="nav-link" href="#"><img style=""
                                                        class="pictute-menu-common"
                                                        src={!! public_url('template/image/icon/icon_4_write.png') !!}>{{ __('messages.set') }}<span><i
                                                            class="fa fa-chevron-right"></i></a>
                                            </li>
                                            <ul class="nav flex-column">
                                        ...
                                        @elseif ($key == 3)
                                            <li class="nav-item nav-item-common" data-toggle="collapse"
                                                ...
                                                <a class="nav-link" href="#"><img style=""
                                                        class="pictute-menu-common"
                                                        src={!! public_url('uploads/ver1.7/icon/icon-prepare.svg') !!}>{{ __('messages.preparation') }}<span><i
                                                            class="fa fa-chevron-right"></i></a>
                                            </li>
                                            <ul class="nav flex-column">
                                                <div class="collapse menu-child-common" id="collapseExample3">
                        ...
                        <div class="col-6">
                            <ul class="nav flex-column">
                                    ...
                                    @foreach ($navbars as $key => $row)
                                        @if ($key == 4)
                                            <li class="nav-item nav-item-common" data-toggle="collapse"
                                                ...
                                                <a class="nav-link" href="#"><img style=""
                                                        class="pictute-menu-common"
                                                        src={!! public_url('uploads/ver1.7/icon/icon-master.svg') !!}>{{ __('messages.weekly_master') }}<span><i
                                                            class="fa fa-chevron-right"></i></a>
                                            </li>
                                            <ul class="nav flex-column">
                                        ...
                                        @elseif ($key == 5)
                                            <li class="nav-item nav-item-common" data-toggle="collapse"
                                                ...
                                                <a class="nav-link" href="#"><img style=""
                                                        class="pictute-menu-common" src={!! public_url('uploads/ver1.7/icon/icon-setting.svg') !!}>
                                                    {{ __('messages.set') }} <span><i
                                                            class="fa fa-chevron-right"></i></a>
                                            </li>
                                        @elseif ($key == 6 && count($row) == 1)
                                            <li class="nav-item nav-item-common" data-toggle="collapse"
                                                href="#collapseExample6" role="button" aria-expanded="false"
                                                aria-controls="collapseExample6">
                                                <a class="nav-link" href="/weeklyreport/rq9001"
                                                    target="_blank">{{ __('messages.my_purpose') }}</a>
                                            </li>

                                            <ul class="nav flex-column">
                                                <div class="collapse menu-child-common" id="collapseExample7">
                                                    @foreach ($row as $screen)
                                                        @if ($screen->function_id != 'weeklyreport/guide')
                                                            <a class="nav-link"
                                                                href="{{ url($screen->function_id) }}">{{ $screen->function_nm }}</a>
                                                        @else
                                                            <a class="nav-link" to="#help"
                                                                href="{{ env('GUIDE_WEEKLYREPORT_ADMIN_URL') }}"
                                                                target="_blank"><span>{{ __('rdashboard.how_to_use_faq') }}<br>{{ __('rdashboard.for_admin') }}</span></a>
                                                        @endif
                                                    @endforeach
                                                </div>
                                            </ul>
                                ...
                                <li class="nav-item nav-item-common">
                                    <a class="nav-link" to="#help"
                                        href="{{ env('GUIDE_WEEKLYREPORT_USER_URL') }}"
                                        target="_blank">{{ __('rdashboard.how_to_use_faq') }}<br>({{ __('rdashboard.for_approver') }})</a>
                                </li>
                                <li class="nav-item nav-item-common">
                                    <a class="nav-link active" id="btn-change-password"
                                        style="color:white; cursor:pointer" aria-current="page"><span></span>
                                        {{ __('messages.change_password') }}</a>
                                    @if (isset($auth->authority_typ) && $auth->authority_typ != '4')
                                        <a class="nav-link active" onclick="location.href='/master/q0071'"
                                ...
                                <li class="nav-item nav-item-common">
                                    <a class="nav-link active" id="btn-change-language"
                                        style="color:white; cursor:pointer" aria-current="page"><span></span>
                                        {{ __('messages.language_setting') }}</a>
                                </li>
                            </ul>
                        </div>
    ...
    <nav class="navbar navbar-expand-md fixed-top header-oneonone header navbar-pc">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
                ...
                <li>
                    <a tabindex="-1" class="nav-link" style="color: red;">
                        @if ($auth->change_pass_status ?? 0 == 1)
                            ...
                            <span
                                style="margin-left: 10px;">{{ __('messages.please_change_your_password') }}（{{ __('messages.day_left_until_expiration') }}
                                {{ $auth->pass_remain ?? 0 }} {{ __('messages.day') }}）</span>
                        @endif
                    </a>
                </li>
            </ul>
            ...
            <ul class="navbar-nav right">
                <li class="nav-item" style="background-color: var(--primary-pink)">
                    <a tabindex="-1" class="nav-link nav-link-weekly-report icon" to="#help"
                        href="{{ env('GUIDE_WEEKLYREPORT_USER_URL') }}" target="_blank">
                        <span
                            style="color: white">{{ __('rdashboard.how_to_use_faq') }}<br>({{ __('rdashboard.for_approver') }})</span>
                    </a>
                </li>
                <li class="dropdown">
    ...
    <div class="main-oneonone ">
        <div class="main-nav main-pc">
            <ul class="list-group mcd-menu">
                @if ($navbars)
                    @foreach ($navbars as $key => $row)
                        <li class="parent-list" @if ($key === 5) style="position: relative;" @endif>
                            @if ($key == 0 && count($row) == 1)
                            ...
                            @elseif($key == 1)
                                <a tabindex="-1" href="#">
                                    <p><img src={!! public_url('uploads/ver1.7/icon/icon-enforce.svg') !!}> </p>
                                    <div>{{ __('messages.implement') }}</div>
                                </a>
                            @elseif($contract_company_attribute == 1 && $key == 2)
                                <a tabindex="-1" href="#">
                            ...
                            @endif
                            @if (count($row) > 0 && !in_array($key, [0, 6]))
                                <ul @if ($key === 5) style="bottom:0" @endif>
                                    @foreach ($row as $screen)
                                        @if ($screen->function_id != 'weeklyreport/guide')
                                            <li><a tabindex="-1" href="{{ url($screen->function_id) }}"><i
                                                        class="fa fa-genderless"></i>{{ $screen->function_nm }}</a>
                                            </li>
                                        @else
                                            <li>
                                                <a tabindex="-1" to="#help"
                                                    href="{{ env('GUIDE_WEEKLYREPORT_ADMIN_URL', '') }}"
                                                    target="_blank"><i
                                                        class="fa fa-genderless"></i>{{ __('rdashboard.how_to_use_faq') }}<br>{{ __('messages.admin_use') }}</a>
                                            </li>
                                        @endif
                                    @endforeach
                                </ul>
        ...
        <div class="content">
            <div class="container-fluid">
                <div class="row" style="height:58px;position:relative">
                    <div class="col-6 col-sm-6 col-md-6 col-lg-6 col-xl-6 header-left-function ">
