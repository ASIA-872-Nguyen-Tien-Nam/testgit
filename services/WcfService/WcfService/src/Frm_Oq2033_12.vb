...
Public Class Frm_Oq2033_12
    Public Function FNC_EXL_Oq2033_12(
       ByVal sql As String,
       ...
       ByVal P5 As String
        ...
        Try
            ...
            If Mid(sql, 8, 2) = "en" Then
                ...
                D_Person = " Person(s)"
                '
                D_EXL_TML = ConfigurationManager.AppSettings("FIL_TEM_EXL") & "\Oq2033_12_en.xlsx"
            Else
                D_EXL_TML = ConfigurationManager.AppSettings("FIL_TEM_EXL") & "\Oq2033_12.xlsx"
            End If
            ...
            Using D_EXL_BOK As New ExcelPackage(newFile)
                ...
                For j = 10 To D_data_detail.Count - 2
                    ...
                    End If
                    If j = 14 Then
                        D_point_typ_5 = Utl_Com.FNC_CNV_NUL(D_data_detail(j)("point").ToString(), 0)
                    End If
                    '
                    D_cl = D_cl + 1
                Next
                ...
                For i = 0 To 9
                    ...
                    '
                    If i <> 0 Then
                        D_EXL_BOK.Workbook.Worksheets(2).Cells("A3:I4").Copy(D_EXL_SHT1.Cells("A" & (16 + (i * 2)) & ":I" & (17 + (i * 2))))
                    End If
                    ...
                    D_EXL_SHT1.Cells(16 + (i * 2), 9).Value = Utl_Com.FNC_CNV_NUL(D_data_detail(i)("sub_total").ToString(), "") & D_Person
                    '
                ...
                Dim k As Integer = 10
                'total
                D_EXL_BOK.Workbook.Worksheets(2).Cells("A5:I6").Copy(D_EXL_SHT1.Cells("A" & (16 + (k * 2)) & ":I" & (17 + (k * 2))))
                '
                'fill data total
                ...
                D_EXL_SHT1.Cells(36, 9).Value = D_total_number & D_Person
                '
        ...
        Catch ex As Exception
            Utl_ERR.WriteLogReport(ex.ToString(), "Oq2033_12")
            message = "FNC_EXL_Oq2033_12: " & ex.ToString()
            status = "201"
        Finally
            '
        End Try
EXIT_FUNCTION:
        FNC_EXL_Oq2033_12 = "{" + """" + "status" + """" + ":" + status + "," + """" + "filename" + """" + ":" + """" + fileName + """," + """" + "message" + """" + ":" + """" + message + """}"
        Exit Function
