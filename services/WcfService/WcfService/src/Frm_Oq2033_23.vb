...
Public Class Frm_Oq2033_23
    Public Function FNC_EXL_Oq2033_23(
       ByVal sql As String,
       ...
       ByVal P5 As String
        ...
        Dim D_total_question_1 As Integer = 0
        Dim D_total_question_2 As Integer = 0
        Dim D_total_question_3 As Integer = 0
        Dim D_total_question_4 As Integer = 0
        Dim D_total_question_5 As Integer = 0
        Dim D_total_question_6 As Integer = 0
        Dim D_total_question_7 As Integer = 0
        Dim D_total_question_8 As Integer = 0
        Dim D_total_question_9 As Integer = 0
        Dim D_total_question_10 As Integer = 0
        ...
        Try
            ...
            If Mid(sql, 8, 2) = "en" Then
                D_Person = " Person(s)"
                '
                D_EXL_TML = ConfigurationManager.AppSettings("FIL_TEM_EXL") & "\Oq2033_23_en.xlsx"
            Else
                D_EXL_TML = ConfigurationManager.AppSettings("FIL_TEM_EXL") & "\Oq2033_23.xlsx"
            End If
            ...
            Using D_EXL_BOK As New ExcelPackage(newFile)
                ...
                For i = 0 To 4
                    ...
                    'total
                    D_total_question_1 = D_total_question_1 + Utl_Com.FNC_CNV_NUL(D_data_detail(i)("questionnaire_1").ToString(), 0)
                    D_total_question_2 = D_total_question_2 + Utl_Com.FNC_CNV_NUL(D_data_detail(i)("questionnaire_2").ToString(), 0)
                    D_total_question_3 = D_total_question_3 + Utl_Com.FNC_CNV_NUL(D_data_detail(i)("questionnaire_3").ToString(), 0)
                    D_total_question_4 = D_total_question_4 + Utl_Com.FNC_CNV_NUL(D_data_detail(i)("questionnaire_4").ToString(), 0)
                    D_total_question_5 = D_total_question_5 + Utl_Com.FNC_CNV_NUL(D_data_detail(i)("questionnaire_5").ToString(), 0)
                    D_total_question_6 = D_total_question_6 + Utl_Com.FNC_CNV_NUL(D_data_detail(i)("questionnaire_6").ToString(), 0)
                    D_total_question_7 = D_total_question_7 + Utl_Com.FNC_CNV_NUL(D_data_detail(i)("questionnaire_7").ToString(), 0)
                    D_total_question_8 = D_total_question_8 + Utl_Com.FNC_CNV_NUL(D_data_detail(i)("questionnaire_8").ToString(), 0)
                    D_total_question_9 = D_total_question_9 + Utl_Com.FNC_CNV_NUL(D_data_detail(i)("questionnaire_9").ToString(), 0)
                    D_total_question_10 = D_total_question_10 + Utl_Com.FNC_CNV_NUL(D_data_detail(i)("questionnaire_10").ToString(), 0)
                    D_total_number = D_total_number + D_data_detail(i)("sub_total").ToString()
                    D_total_percent_0 = D_total_percent_0 + Utl_Com.FNC_CNV_NUL(D_data_detail(i)("questionnaire_percent_1").ToString(), 0)
                    D_total_percent_1 = D_total_percent_1 + Utl_Com.FNC_CNV_NUL(D_data_detail(i)("questionnaire_percent_2").ToString(), 0)
                    D_total_percent_2 = D_total_percent_2 + Utl_Com.FNC_CNV_NUL(D_data_detail(i)("questionnaire_percent_3").ToString(), 0)
                    D_total_percent_3 = D_total_percent_3 + Utl_Com.FNC_CNV_NUL(D_data_detail(i)("questionnaire_percent_4").ToString(), 0)
                    D_total_percent_4 = D_total_percent_4 + Utl_Com.FNC_CNV_NUL(D_data_detail(i)("questionnaire_percent_5").ToString(), 0)
                    D_total_percent_5 = D_total_percent_5 + Utl_Com.FNC_CNV_NUL(D_data_detail(i)("questionnaire_percent_6").ToString(), 0)
                    D_total_percent_6 = D_total_percent_6 + Utl_Com.FNC_CNV_NUL(D_data_detail(i)("questionnaire_percent_7").ToString(), 0)
                    D_total_percent_7 = D_total_percent_7 + Utl_Com.FNC_CNV_NUL(D_data_detail(i)("questionnaire_percent_8").ToString(), 0)
                    D_total_percent_8 = D_total_percent_8 + Utl_Com.FNC_CNV_NUL(D_data_detail(i)("questionnaire_percent_9").ToString(), 0)
                    D_total_percent_9 = D_total_percent_9 + Utl_Com.FNC_CNV_NUL(D_data_detail(i)("questionnaire_percent_10").ToString(), 0)
                    '
                Next
                Dim k As Integer = 5
                'total
                ...
                '
                'fill data total
                D_EXL_SHT1.Cells(26, 3).Value = D_total_question_10 & D_Person
                D_EXL_SHT1.Cells(26, 4).Value = D_total_question_9 & D_Person
                D_EXL_SHT1.Cells(26, 5).Value = D_total_question_8 & D_Person
                D_EXL_SHT1.Cells(26, 6).Value = D_total_question_7 & D_Person
                D_EXL_SHT1.Cells(26, 7).Value = D_total_question_6 & D_Person
                D_EXL_SHT1.Cells(26, 8).Value = D_total_question_5 & D_Person
                D_EXL_SHT1.Cells(26, 9).Value = D_total_question_4 & D_Person
                D_EXL_SHT1.Cells(26, 10).Value = D_total_question_3 & D_Person
                D_EXL_SHT1.Cells(26, 11).Value = D_total_question_2 & D_Person
                D_EXL_SHT1.Cells(26, 12).Value = D_total_question_1 & D_Person
        ...
        Catch ex As Exception
            Utl_ERR.WriteLogReport(ex.ToString(), "Oq2033_23")
            message = "FNC_EXL_Oq2033_23: " & ex.ToString()
            status = "201"
        Finally
            '
        End Try
EXIT_FUNCTION:
        FNC_EXL_Oq2033_23 = "{" + """" + "status" + """" + ":" + status + "," + """" + "filename" + """" + ":" + """" + fileName + """," + """" + "message" + """" + ":" + """" + message + """}"
        Exit Function
