...
Public Class Frm_Oq2033_31
    Public Function FNC_EXL_Oq2033_31(
       ByVal sql As String,
       ...
       ByVal P5 As String
        ...
        Try
            ...
            If Mid(sql, 8, 2) = "en" Then
                ...
                D_PT = " pts"
                '
                D_EXL_TML = ConfigurationManager.AppSettings("FIL_TEM_EXL") & "\Oq2033_31_en.xlsx"
            Else
                D_EXL_TML = ConfigurationManager.AppSettings("FIL_TEM_EXL") & "\Oq2033_31.xlsx"
            End If
            ...
            Using D_EXL_BOK As New ExcelPackage(newFile)
                ...
                '
                'fill data total
                D_EXL_SHT1.Cells(36, 3).Value = D_total_no_9 & D_Person
                D_EXL_SHT1.Cells(36, 4).Value = D_total_no_8 & D_Person
                D_EXL_SHT1.Cells(36, 5).Value = D_total_no_7 & D_Person
                D_EXL_SHT1.Cells(36, 6).Value = D_total_no_6 & D_Person
                D_EXL_SHT1.Cells(36, 7).Value = D_total_no_5 & D_Person
                D_EXL_SHT1.Cells(36, 8).Value = D_total_no_4 & D_Person
                D_EXL_SHT1.Cells(36, 9).Value = D_total_no_3 & D_Person
                D_EXL_SHT1.Cells(36, 10).Value = D_total_no_2 & D_Person
                D_EXL_SHT1.Cells(36, 11).Value = D_total_no_1 & D_Person
                D_EXL_SHT1.Cells(36, 12).Value = D_total_no_0 & D_Person
                D_EXL_SHT1.Cells(36, 13).Value = D_total_number & D_Person
                '
                D_EXL_SHT1.Cells(37, 3).Value = D_total_percent_9 & "%"
                D_EXL_SHT1.Cells(37, 4).Value = D_total_percent_8 & "%"
                D_EXL_SHT1.Cells(37, 5).Value = D_total_percent_7 & "%"
                D_EXL_SHT1.Cells(37, 6).Value = D_total_percent_6 & "%"
                D_EXL_SHT1.Cells(37, 7).Value = D_total_percent_5 & "%"
                D_EXL_SHT1.Cells(37, 8).Value = D_total_percent_4 & "%"
                D_EXL_SHT1.Cells(37, 9).Value = D_total_percent_3 & "%"
                D_EXL_SHT1.Cells(37, 10).Value = D_total_percent_2 & "%"
                D_EXL_SHT1.Cells(37, 11).Value = D_total_percent_1 & "%"
                D_EXL_SHT1.Cells(37, 12).Value = D_total_percent_0 & "%"
                '
                'meger cell
        ...
        Catch ex As Exception
            Utl_ERR.WriteLogReport(ex.ToString(), "Oq2033_31")
            message = "FNC_EXL_Oq2033_31: " & ex.ToString()
            status = "201"
        Finally
            '
        End Try
EXIT_FUNCTION:
        FNC_EXL_Oq2033_31 = "{" + """" + "status" + """" + ":" + status + "," + """" + "filename" + """" + ":" + """" + fileName + """," + """" + "message" + """" + ":" + """" + message + """}"
        Exit Function
