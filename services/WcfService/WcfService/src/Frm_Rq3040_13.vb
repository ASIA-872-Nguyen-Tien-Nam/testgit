...
Public Class Frm_Rq3040_13
    Public Function FNC_EXL_Rq3040_13(
       ByVal sql As String,
       ...
       ByVal P5 As String
        ...
        Try
            ...
            If D_ROW_CNT = 0 Then
                status = "203"
                message = "FNC_EXL_Rq3040_13: Data is empty"
                GoTo EXIT_FUNCTION
            End If
            '
            If Mid(sql, 8, 2) = "en" Then
                D_Person = " Person(s)"
                '
                D_EXL_TML = ConfigurationManager.AppSettings("FIL_TEM_EXL") & "\Rq3040_13_en.xlsx"
            Else
                D_EXL_TML = ConfigurationManager.AppSettings("FIL_TEM_EXL") & "\Rq3040_13.xlsx"
            End If
            ...
            Using D_EXL_BOK As New ExcelPackage(newFile)
                ...
                D_EXL_SHT1.Cells(4, 1).Value = Utl_Com.FNC_CNV_NUL(D_data_detail(14)("organization_hd_1").ToString(), "")
                D_EXL_SHT1.Cells(5, 1).Value = Utl_Com.FNC_CNV_NUL(D_data_detail(14)("organization_hd_2").ToString(), "")
                D_EXL_SHT1.Cells(6, 1).Value = Utl_Com.FNC_CNV_NUL(D_data_detail(14)("organization_hd_3").ToString(), "")
                D_EXL_SHT1.Cells(7, 1).Value = Utl_Com.FNC_CNV_NUL(D_data_detail(14)("organization_hd_4").ToString(), "")
                D_EXL_SHT1.Cells(8, 1).Value = Utl_Com.FNC_CNV_NUL(D_data_detail(14)("organization_hd_5").ToString(), "")
                'fill search conditions
                D_EXL_SHT1.Cells(1, 2).Value = Utl_Com.FNC_CNV_NUL(D_data_detail(14)("fiscal_year_nm").ToString(), "")
                D_EXL_SHT1.Cells(2, 2).Value = Utl_Com.FNC_CNV_NUL(D_data_detail(14)("combination_vertical").ToString(), "")
                D_EXL_SHT1.Cells(3, 2).Value = Utl_Com.FNC_CNV_NUL(D_data_detail(14)("combination_horizontal").ToString(), "")
                D_EXL_SHT1.Cells(4, 2).Value = Utl_Com.FNC_CNV_NUL(D_data_detail(14)("organization_nm_1").ToString(), "")
                D_EXL_SHT1.Cells(5, 2).Value = Utl_Com.FNC_CNV_NUL(D_data_detail(14)("organization_nm_2").ToString(), "")
                D_EXL_SHT1.Cells(6, 2).Value = Utl_Com.FNC_CNV_NUL(D_data_detail(14)("organization_nm_3").ToString(), "")
                D_EXL_SHT1.Cells(7, 2).Value = Utl_Com.FNC_CNV_NUL(D_data_detail(14)("organization_nm_4").ToString(), "")
                D_EXL_SHT1.Cells(8, 2).Value = Utl_Com.FNC_CNV_NUL(D_data_detail(14)("organization_nm_5").ToString(), "")
                D_EXL_SHT1.Cells(9, 2).Value = Utl_Com.FNC_CNV_NUL(D_data_detail(14)("group_cd_nm").ToString(), "")
                D_EXL_SHT1.Cells(10, 2).Value = Utl_Com.FNC_CNV_NUL(D_data_detail(14)("position_nm").ToString(), "")
                D_EXL_SHT1.Cells(11, 2).Value = Utl_Com.FNC_CNV_NUL(D_data_detail(14)("grade_nm").ToString(), "")
                D_EXL_SHT1.Cells(12, 2).Value = Utl_Com.FNC_CNV_NUL(D_data_detail(14)("job_nm").ToString(), "")
                ...
                For i = 0 To 9
                    ...
                    If Utl_Com.FNC_CNV_NUL(D_data_detail(i)("sub_total").ToString(), 0) > 0 Then
                        D_point_average = (((Utl_Com.FNC_CNV_NUL(D_data_detail(i)("item_no_1").ToString(), 0) * D_point_typ_1) + (Utl_Com.FNC_CNV_NUL(D_data_detail(i)("item_no_2").ToString(), 0) * D_point_typ_2) + (Utl_Com.FNC_CNV_NUL(D_data_detail(i)("item_no_3").ToString(), 0) * D_point_typ_3) + (Utl_Com.FNC_CNV_NUL(D_data_detail(i)("item_no_4").ToString(), 0) * D_point_typ_4)) / (Utl_Com.FNC_CNV_NUL(D_data_detail(i)("sub_total").ToString(), 0)))
                        D_point_average = Math.Round(D_point_average, 2)
                    End If
                    D_EXL_SHT1.Cells(16 + (i * 2), 7).Value = D_point_average
                    '
                    'total
                    D_total_item_no_1 = D_total_item_no_1 + D_data_detail(i)("item_no_1").ToString()
                    D_total_item_no_2 = D_total_item_no_2 + D_data_detail(i)("item_no_2").ToString()
                    D_total_item_no_3 = D_total_item_no_3 + D_data_detail(i)("item_no_3").ToString()
                    D_total_item_no_4 = D_total_item_no_4 + D_data_detail(i)("item_no_4").ToString()
                    ...
                    D_total_percent_1 = D_total_percent_1 + D_data_detail(i)("item_no_percent1").ToString()
                    D_total_percent_2 = D_total_percent_2 + D_data_detail(i)("item_no_percent2").ToString()
                    D_total_percent_3 = D_total_percent_3 + D_data_detail(i)("item_no_percent3").ToString()
                    D_total_percent_4 = D_total_percent_4 + D_data_detail(i)("item_no_percent4").ToString()
        ...
        Catch ex As Exception
            Utl_ERR.WriteLogReport(ex.ToString(), "Rq3040_13")
            message = "FNC_EXL_Rq3040_13: " & ex.ToString()
            status = "201"
        Finally
            '
        End Try
EXIT_FUNCTION:
        FNC_EXL_Rq3040_13 = "{" + """" + "status" + """" + ":" + status + "," + """" + "filename" + """" + ":" + """" + fileName + """," + """" + "message" + """" + ":" + """" + message + """}"
        Exit Function
