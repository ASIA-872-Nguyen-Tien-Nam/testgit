...
Public Class Frm_Rq3040_21
    Public Function FNC_EXL_Rq3040_21(
       ByVal sql As String,
       ...
       ByVal P5 As String
        ...
        Try
            ...
            If D_ROW_CNT = 0 Then
                status = "203"
                message = "FNC_EXL_Rq3040_21: Data is empty"
                GoTo EXIT_FUNCTION
            End If
            '
            If Mid(sql, 8, 2) = "en" Then
                D_Person = " Person(s)"
                '
                D_EXL_TML = ConfigurationManager.AppSettings("FIL_TEM_EXL") & "\Rq3040_21_en.xlsx"
            Else
                D_EXL_TML = ConfigurationManager.AppSettings("FIL_TEM_EXL") & "\Rq3040_21.xlsx"
            End If
        ...
        Catch ex As Exception
            Utl_ERR.WriteLogReport(ex.ToString(), "Rq3040_21")
            message = "FNC_EXL_Rq3040_21: " & ex.ToString()
            status = "201"
        Finally
            '
        End Try
EXIT_FUNCTION:
        FNC_EXL_Rq3040_21 = "{" + """" + "status" + """" + ":" + status + "," + """" + "filename" + """" + ":" + """" + fileName + """," + """" + "message" + """" + ":" + """" + message + """}"
        Exit Function
