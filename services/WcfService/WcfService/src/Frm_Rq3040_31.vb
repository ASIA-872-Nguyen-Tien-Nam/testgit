...
Public Class Frm_Rq3040_31
    Public Function FNC_EXL_Rq3040_31(
       ByVal sql As String,
       ...
       ByVal P5 As String
        ...
        Try
            ...
            If D_ROW_CNT = 0 Then
                status = "203"
                message = "FNC_EXL_Rq3040_31: Data is empty"
                GoTo EXIT_FUNCTION
            End If
            '
            If Mid(sql, 8, 2) = "en" Then
                D_Person = " Person(s)"
                '
                D_EXL_TML = ConfigurationManager.AppSettings("FIL_TEM_EXL") & "\Rq3040_31_en.xlsx"
            Else
                D_EXL_TML = ConfigurationManager.AppSettings("FIL_TEM_EXL") & "\Rq3040_31.xlsx"
            End If
            ...
            Using D_EXL_BOK As New ExcelPackage(newFile)
                ...
                D_EXL_SHT1.Cells(4, 1).Value = Utl_Com.FNC_CNV_NUL(D_data_detail(8)("organization_hd_1").ToString(), "")
                D_EXL_SHT1.Cells(5, 1).Value = Utl_Com.FNC_CNV_NUL(D_data_detail(8)("organization_hd_2").ToString(), "")
                D_EXL_SHT1.Cells(6, 1).Value = Utl_Com.FNC_CNV_NUL(D_data_detail(8)("organization_hd_3").ToString(), "")
                D_EXL_SHT1.Cells(7, 1).Value = Utl_Com.FNC_CNV_NUL(D_data_detail(8)("organization_hd_4").ToString(), "")
                D_EXL_SHT1.Cells(8, 1).Value = Utl_Com.FNC_CNV_NUL(D_data_detail(8)("organization_hd_5").ToString(), "")
                'fill search conditions
                D_EXL_SHT1.Cells(1, 2).Value = Utl_Com.FNC_CNV_NUL(D_data_detail(8)("fiscal_year_nm").ToString(), "")
                D_EXL_SHT1.Cells(2, 2).Value = Utl_Com.FNC_CNV_NUL(D_data_detail(8)("combination_vertical").ToString(), "")
                D_EXL_SHT1.Cells(3, 2).Value = Utl_Com.FNC_CNV_NUL(D_data_detail(8)("combination_horizontal").ToString(), "")
                D_EXL_SHT1.Cells(4, 2).Value = Utl_Com.FNC_CNV_NUL(D_data_detail(8)("organization_nm_1").ToString(), "")
                D_EXL_SHT1.Cells(5, 2).Value = Utl_Com.FNC_CNV_NUL(D_data_detail(8)("organization_nm_2").ToString(), "")
                D_EXL_SHT1.Cells(6, 2).Value = Utl_Com.FNC_CNV_NUL(D_data_detail(8)("organization_nm_3").ToString(), "")
                D_EXL_SHT1.Cells(7, 2).Value = Utl_Com.FNC_CNV_NUL(D_data_detail(8)("organization_nm_4").ToString(), "")
                D_EXL_SHT1.Cells(8, 2).Value = Utl_Com.FNC_CNV_NUL(D_data_detail(8)("organization_nm_5").ToString(), "")
                D_EXL_SHT1.Cells(9, 2).Value = Utl_Com.FNC_CNV_NUL(D_data_detail(8)("group_cd_nm").ToString(), "")
                D_EXL_SHT1.Cells(10, 2).Value = Utl_Com.FNC_CNV_NUL(D_data_detail(8)("position_nm").ToString(), "")
                D_EXL_SHT1.Cells(11, 2).Value = Utl_Com.FNC_CNV_NUL(D_data_detail(8)("grade_nm").ToString(), "")
                D_EXL_SHT1.Cells(12, 2).Value = Utl_Com.FNC_CNV_NUL(D_data_detail(8)("job_nm").ToString(), "")
                Dim D_cl As Integer = 0
                'picture
                For j = 4 To D_data_detail.Count - 2
                ...
                '
                'fill data total
                D_EXL_SHT1.Cells(24, 3).Value = D_total_no_9 & D_Person
                D_EXL_SHT1.Cells(24, 4).Value = D_total_no_8 & D_Person
                D_EXL_SHT1.Cells(24, 5).Value = D_total_no_7 & D_Person
                D_EXL_SHT1.Cells(24, 6).Value = D_total_no_6 & D_Person
                D_EXL_SHT1.Cells(24, 7).Value = D_total_no_5 & D_Person
                D_EXL_SHT1.Cells(24, 8).Value = D_total_no_4 & D_Person
                D_EXL_SHT1.Cells(24, 9).Value = D_total_no_3 & D_Person
                D_EXL_SHT1.Cells(24, 10).Value = D_total_no_2 & D_Person
                D_EXL_SHT1.Cells(24, 11).Value = D_total_no_1 & D_Person
                D_EXL_SHT1.Cells(24, 12).Value = D_total_no_0 & D_Person
                D_EXL_SHT1.Cells(24, 13).Value = D_total_number & D_Person
                '
                D_EXL_SHT1.Cells(25, 3).Value = D_total_percent_9 & "%"
                D_EXL_SHT1.Cells(25, 4).Value = D_total_percent_8 & "%"
                D_EXL_SHT1.Cells(25, 5).Value = D_total_percent_7 & "%"
                D_EXL_SHT1.Cells(25, 6).Value = D_total_percent_6 & "%"
                D_EXL_SHT1.Cells(25, 7).Value = D_total_percent_5 & "%"
                D_EXL_SHT1.Cells(25, 8).Value = D_total_percent_4 & "%"
                D_EXL_SHT1.Cells(25, 9).Value = D_total_percent_3 & "%"
                D_EXL_SHT1.Cells(25, 10).Value = D_total_percent_2 & "%"
                D_EXL_SHT1.Cells(25, 11).Value = D_total_percent_1 & "%"
                D_EXL_SHT1.Cells(25, 12).Value = D_total_percent_0 & "%"
                '
                'D_EXL_BOK.Workbook.Worksheets.Delete(2)
                'Save file
                If Mid(sql, 8, 2) = "en" Then
                    For i = 3 To 12
                        D_EXL_SHT1.Column(i).Style.Font.Size = 10
                    Next
                End If
                D_EXL_BOK.Save()
            End Using
        Catch ex As Exception
            Utl_ERR.WriteLogReport(ex.ToString(), "Rq3040_31")
            message = "FNC_EXL_Rq3040_31: " & ex.ToString()
            status = "201"
        Finally
            '
        End Try
EXIT_FUNCTION:
        FNC_EXL_Rq3040_31 = "{" + """" + "status" + """" + ":" + status + "," + """" + "filename" + """" + ":" + """" + fileName + """," + """" + "message" + """" + ":" + """" + message + """}"
        Exit Function
